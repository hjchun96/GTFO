...
export default class HomeScreen extends React.Component {
  ...
  render() {
    ...
    return ( <
      ...
      Image source = {
        __DEV__ ?
        require('../assets/images/flame.png') : require('../assets/images/flame.png')
      }
      style = {
        styles.welcomeImage
      }
      ...
      onPress = {
        () => this._handleAddBuildingButtonPressed()
      }
      textStyle = {
        {
          color: "#bcbec1"
